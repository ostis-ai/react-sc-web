...
export const scrollToNotVisibleELem = (elem: HTMLElement, scrollElem: HTMLElement) => {
  ...
  const overBottom =
    offsetFromScrollWrap + elem.clientHeight > scrollElem.scrollTop + scrollElem.clientHeight;
...
export const getTextHighlightMeta = (
  text = '',
  highlight = '',
  highlightFormat: HighlightFormat = 'word',
) => {
  ...
  const shouldHiglight = !highlight
    ? true
...
export function changeInputData(
  input: HTMLInputElement | HTMLTextAreaElement,
  toChangeData: InputData,
) {
