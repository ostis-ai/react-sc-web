...
export const ConstantSearchSelectProvider = ({
  ...
  <ConstantSearchSelectContext.Provider value={restProps}>
    {children}
  </ConstantSearchSelectContext.Provider>
);
...
export const DropDownSearchSelectProvider = ({
  ...
  <DropDownSearchSelectContext.Provider value={restProps}>
    {children}
  </DropDownSearchSelectContext.Provider>
);
...
export const OptionGroupProvider = ({
  children,
  ...restProps
}: PropsWithChildren<IOptionGroupContext>) => (
