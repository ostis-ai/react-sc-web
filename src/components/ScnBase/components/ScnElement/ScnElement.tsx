...
import { IScnNode } from '@components/ScnBase/model';
import { useScnContext } from '@components/ScnBase/ScnContext';
import { useScUtils } from 'ostis-ui-lib';
import { TScLanguageTab } from 'ostis-ui-lib';
import { langToKeynode } from 'ostis-ui-lib';
import { snakeToCamelCase } from 'ostis-ui-lib';
...
import { getRandomInt } from 'ostis-ui-lib';
                  ...
                  {modifiers.map((modifier) => (
                    <Fragment key={`${arc.addr}${modifier.addr}`}>
                      <ScnLink
                        addr={modifier.addr}
                        loaderHeight={18}
                        loaderWidth={`${getRandomInt(20, 60)}%`}
                      />
