...
export const initiateComponentInstallAgent = async (component: ScAddr) => {
    ...
    construction.generateConnector(ScType.ConstPermPosArc, actionNode, componentsInstall, componentsInstallArc);
    ...
    construction.generateConnector(ScType.ConstPermPosArc, componentsInstall, components, componentsArc);
